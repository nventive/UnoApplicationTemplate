...
namespace ApplicationTemplate.Shared.Views.Behaviors
{
	/// <summary>
	/// This is a copy of the Umbrella.View behavior as of commit d812bbf2fa3b7583901d284133fd7a08f366c11b.
	/// We added this file to the project so that we could override the FormattingTextBoxBehavior.cs
	/// file and have the behavior work normally on Android.
	/// </summary>
