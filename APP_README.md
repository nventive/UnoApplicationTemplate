...
| [Name of Main Pipeline](link-to-pipeline)| [`.azure-pipelines.yml`](.azure-pipelines.yml)| Build and deploy the application to TestFairy, TestFlight, and GooglePlay. | Changes on the `main` branch.<br/>Manual trigger.
...
| [Name of Canary Pipeline](link-to-pipeline)| [`.azure-pipelines-canary.yml`](.azure-pipelines.yml)| Build and deploy canary versions of the app to TestFairy and TestFlight. | Upon creation of branches with the `canary/build/*` pattern.
